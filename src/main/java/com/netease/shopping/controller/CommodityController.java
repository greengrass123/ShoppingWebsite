...
import static com.netease.shopping.constant.StatusCode.ER7001;
import static com.netease.shopping.constant.StatusCode.ER7002;
...
public class CommodityController {
    ...
    //内容总数控制在1000以内
    private static int COMMODITY_NUM=1000;
    ...
    public ModelAndView addCommodity(@RequestParam("imgPath") String imgPath, @RequestParam("title") String title, @RequestParam("summary") String summary,
        ...
        if (session.getAttribute("user") != null) {
            ...
            if(commodityService.count()<COMMODITY_NUM){
                ...
                modelAndView.setViewName("publish");
                modelAndView.addObject("msg", "内容已经超过1000条");
            }
